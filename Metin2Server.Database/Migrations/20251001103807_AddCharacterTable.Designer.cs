...
namespace Metin2Server.Database.Migrations
{
    ...
    [Migration("20251001103807_AddCharacterTable")]
            ...
            modelBuilder.Entity("Metin2Server.Domain.Entities.CharacterQuickSlot", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_character_quick_slot");

                    b.HasIndex("CharacterId")
                        .HasDatabaseName("ix_character_quick_slot_character_id");

                    b.ToTable("character_quick_slot", (string)null);
                });
            ...
            modelBuilder.Entity("Metin2Server.Domain.Entities.CharacterSkill", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_character_skill");

                    b.HasIndex("CharacterId")
                        .HasDatabaseName("ix_character_skill_character_id");
            ...
            modelBuilder.Entity("Metin2Server.Domain.Entities.CharacterQuickSlot", b =>
                {
                    b.HasOne("Metin2Server.Domain.Entities.Character", "Character")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_character_quick_slot_character_character_id");
            ...
            modelBuilder.Entity("Metin2Server.Domain.Entities.CharacterSkill", b =>
                {
                    b.HasOne("Metin2Server.Domain.Entities.Character", "Character")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_character_skill_character_character_id");
